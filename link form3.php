...
echo"Mengirim 3 variabel sekaligus ke halaman link4.php.php<br>";
echo"<input name=\"kampusku\" type=\"hidden\" value=\"$kampusku\">";
echo"<input name=\"alamat1\" type=\"hidden\" value=\"$alamat1\">";
echo"<input name=\"alamat2\" type=\"hidden\" value=\"$alamat1\">";
echo"<br><input name=\"kirin\" type=\"submit\" value=\"Kirimkan\">";
echo"</form>
?>
</body>
</html>
